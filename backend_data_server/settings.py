...
SECRET_KEY = 'django-insecure-d5l8_(0y%4t2+kfly$z)ylbrsq$jv3cb%uys4ae9a^awm*qyg*'
...
FIREBASE_CREDENTIALS_PATH = credentials.Certificate("secrets/landing_key.json")
